...
if platform.system().lower() == "windows":
    ...
    lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "libs", "secret_envs.dll"))
elif platform.system().lower() == "linux":
    # lib_path = "./libs/libsecret_envs.so"
    lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "libs", "libsecret_envs.so"))
elif platform.system().lower() == "darwin":
    if "intel" in platform.processor().lower():
        # lib_path = "./libs/libsecret_envs_intel_macos.dylib"
        lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "libs", "libsecret_envs_intel_macos.dylib"))
    else:
        # lib_path = "./libs/libsecret_envs.dylib"
        lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "libs", "libsecret_envs.dylib"))
